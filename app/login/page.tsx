        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-5 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/30 hover:shadow-blue-500/40 disabled:opacity-60 disabled:cursor-not-allowed text-sm mt-1 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
